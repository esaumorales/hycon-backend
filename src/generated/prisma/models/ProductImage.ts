...
export type ProductImageWhereInput = {
  ...
  imageId?: Prisma.IntFilter<"ProductImage"> | number
...
export type ProductImageScalarWhereWithAggregatesInput = {
  ...
  imageId?: Prisma.IntWithAggregatesFilter<"ProductImage"> | number
...
export type ProductImageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"imageId" | "productId" | "imageUrl" | "isThumbnail" | "sortOrder", ExtArgs["result"]["productImage"]>
...
export interface ProductImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const productImageWithImageIdOnly = await prisma.productImage.findMany({ select: { imageId: true } })
   * 
   */
   ...
   * const productImageWithImageIdOnly = await prisma.productImage.createManyAndReturn({
   *   select: { imageId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ProductImages and only return the `imageId`
   * const productImageWithImageIdOnly = await prisma.productImage.updateManyAndReturn({
   *   select: { imageId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProductImageFieldRefs {
  readonly imageId: Prisma.FieldRef<"ProductImage", 'Int'>
